    ...
    public static class DamagePatches
    {
            ...
            DamageSource damageSource)
        {
            try
            {
                ...
                byte damageType = 0; // bullet by default
                ...
                {
                    damageType = 1; // missile/explosive
                }
        ...
        public static void HandleReceivedDamage(DamagePacket packet)
        {
            try
            {
                ...
                // Convert ABSOLUTE hit position back to LOCAL coordinates
                ...
                Plugin.Log?.LogInfo($"[DamagePatches] Hit pos absolute={absoluteHitPos} local={localHitPos}");
                ...
                // Apply damage using the public method
